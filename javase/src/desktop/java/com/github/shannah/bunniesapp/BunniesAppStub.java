...
package com.github.shannah.bunniesapp;
 ...
 * @author Shai Almog
 */
public class BunniesAppStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Bunnies App";
    private static final String APP_NAME = "bunnies-app";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new BunniesAppStub());
    }
